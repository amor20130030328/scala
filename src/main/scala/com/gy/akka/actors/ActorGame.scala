package com.gy.akka.actors

import akka.actor.{ActorSystem, Props}
import com.gy.akka.actors.AActor
...
object ActorGame extends  App{
   ...
   val actorSystem = ActorSystem("actorFactory")
   val bActorRef = actorSystem.actorOf(Props[BActor] , "bActor")
   val aActorRef = actorSystem.actorOf(Props(new AActor(bActorRef)), "aActor")
