package com.gy.design.pattern.decorator

import com.gy.design.pattern.decorator.mycoffee.{DeCaf, Espresso}
import com.gy.design.pattern.decorator.mydecorator.Milk
...
object CoffeeBar {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val caf : Drink = new DeCaf

    println( caf.getDescription() )


    var coffe : Drink = new Espresso
    coffe = new Milk(coffe)

    coffe = new Milk(coffe)

    println(coffe.getDescription() +" , "+ coffe.cost())
