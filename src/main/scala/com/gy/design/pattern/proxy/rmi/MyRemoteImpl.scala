package com.gy.design.pattern.proxy.rmi
...
object  MyRemoteImpl{
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Naming.rebind("rmi://127.0.0.1:8080/RemoteHello", service)

    LocateRegistry.createRegistry(9000);
    Naming.rebind("//127.0.0.1:9000/RemoteHello",service);
    println("远程服务开启，在127.0.0.1 的 9000端口监听，服务名 RemoteHello")
