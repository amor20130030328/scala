package com.gy.design.pattern.proxy.remotecandymachine.client

import java.rmi.Naming

import com.gy.design.pattern.proxy.remotecandymachine.server.CandyMachineRemote
