package com.gy.design.pattern.observer.observer
...
trait Subject {
  ...
  def registerObserver(o : ObServer)     //注册
  def removeObserver(o : ObServer)      //移除
  def notifyObservers()    //通知
