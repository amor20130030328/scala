package com.gy.design.pattern.abstractfactory.order

import com.gy.design.pattern.abstractfactory.AbstractFactory
import com.gy.design.pattern.abstractfactory.pizza.Pizza
...
class OrderPizza {
  ...
  var absFactory : AbstractFactory = _

  def this(absFactory : AbstractFactory){  // 多态
    this
    breakable{
