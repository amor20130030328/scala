package com.gy.design.pattern.abstractfactory.factory

import com.gy.design.pattern.abstractfactory.AbstractFactory
import com.gy.design.pattern.abstractfactory.pizza.{BJCheesePizza, BJPepperPizza, Pizza}
...
//这是一个实现了抽象工厂的一个工厂子类
//如果我们希望订购北京的 pizza 就使用该工厂子类
class LDFactory extends  AbstractFactory{

  override def createPizza(str: String) = {
      var pizza : Pizza = null
      if("cheese".equals(str)){
        pizza = new BJCheesePizza
      }else if("pepper".equals(str)) {
